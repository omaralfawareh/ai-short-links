/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 4de93b42d522fd64df5e23f27a67db46)
// Runtime types generated with workerd@1.20260116.0 2026-01-22 nodejs_compat
declare namespace Cloudflare {
    ...
    interface Env {
        ...
        TURNSTILE_SECRET_KEY_THEME: string;
        TURNSTILE_SECRET_KEY_ALIAS: string;
        TURNSTILE_SECRET_KEY_CUSTOM: string;
        ASSETS: Fetcher;
    }
}
...
declare namespace NodeJS {
    interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_API_KEY" | "OPENAI_API_KEY" | "TURNSTILE_SECRET_KEY_THEME" | "TURNSTILE_SECRET_KEY_ALIAS" | "TURNSTILE_SECRET_KEY_CUSTOM">> { }
}
